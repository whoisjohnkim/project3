...
class Login extends Component {
    ...
    state = {
      ...
      handleLoginButton = event => {
        ...
        axios.post("/api/login", {email: this.state.email, password: this.state.password}).then(function(response){
        ...
        return (
            <div>
                ...
                <div id="right">
                    ...
                    <button type="submit" onClick={this.handleLoginButton} class="btn btn-primary">Submit</button>
                    </form>
                </div>
            </div>
        )
